...
Route::resource('foodswithcategories', 'API\FoodCategoryAPIController');
...
Route::resource('res_categories', 'API\RestaurantCategoryAPIController');   
    Route::resource('banners', 'API\BannersAPIController'); 
        
    Route::resource('offer', 'API\OfferAPIController');
