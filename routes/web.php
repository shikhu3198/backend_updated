...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => ['permission:app-settings']], function () {
        Route::prefix('settings')->group(function () {
            ...
            Route::get('drivers_available/checkActiveOrNot/{id}', 'DriversavailableController@checkActiveOrNot')->name('drivers_available.checkActiveOrNot');
            Route::get('drivers_available/getUser', 'DriversavailableController@getUser')->name('drivers_available.getUser');
            Route::resource('drivers_available', 'DriversavailableController');
    ...
    Route::post('res_categories/remove-media', 'RestaurantCategoryController@removeMedia');
    Route::resource('res_categories', 'RestaurantCategoryController')->except([
        'show'
    ]);

    Route::get('banners/getType', 'BannersController@getType')->name('banners.getType');
    Route::resource('banners', 'BannersController')->except([
        'show'
    ]);
    
    Route::get('offer/getType', 'OfferController@getType')->name('offer.getType');
    ...
    Route::get('update-order-notification', 'FoodOrderController@updateOrderJson');
