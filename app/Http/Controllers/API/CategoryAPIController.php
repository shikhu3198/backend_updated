...
class CategoryAPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        {   
            $categories = Category::select('categories.*')
                ...
                ->where('restaurants.res_category_id',$res_category_id)
    ...
    public function show($id)
    {
        ...
        {
            $categories = $this->categoryRepository->findWithoutFail($id);
        }
        ...
        return $this->sendResponse($categories->toArray(), 'Category retrieved successfully');
    }
