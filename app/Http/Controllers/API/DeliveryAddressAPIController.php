...
class DeliveryAddressAPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $deliveryAddresses = $this->deliveryAddressRepository->orderBy('id', 'DESC')->all();

        $deliveryAddresses = $deliveryAddresses->filter(function ($value, $key) {   
            return $value->is_display == 1; 
        })->values(); 
