...
class BannersDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(Banners::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', Banners::class)->where('in_table', '=', true)->get();
