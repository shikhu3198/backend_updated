...
@can('restaurants.index')
    <li class="nav-item has-treeview {{ (Request::is('res_categories*') || Request::is('restaurants*') || Request::is('galleries*') || Request::is('restaurantReviews*')) && !Request::is('restaurantsPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('res_categories*') || Request::is('restaurants*') || Request::is('galleries*') || Request::is('restaurantReviews*')) && !Request::is('restaurantsPayouts*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-cutlery"></i>@endif
            <p>{{trans('lang.restaurant_plural')}} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('res_categories.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('res_categories*') ? 'active' : '' }}" href="{!! route('res_categories.index') !!}">@if($icons)
...
@can('banners.index')
<li class="nav-item has-treeview {{ Request::is('banners*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('banners*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-picture-o"></i>@endif
            <p>{{trans('lang.banners_plural')}} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('banners.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('banners*') ? 'active' : '' }}" href="{!! route('banners.index') !!}">@if($icons)
                        <i class="nav-icon fa fa-picture-o"></i>@endif<p>{{trans('lang.banners')}}</p></a>
                </li>
            @endcan
...
@can('offer.index')
<li class="nav-item has-treeview {{ Request::is('offer*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('offer*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-picture-o"></i>@endif
            <p>{{trans('lang.offer_plural')}} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('offer.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('offer*') ? 'active' : '' }}" href="{!! route('offer.index') !!}">@if($icons)
                        <i class="nav-icon fa fa-picture-o"></i>@endif<p>{{trans('lang.offer')}}</p></a>
                </li>
            @endcan
