...
<!-- Theme style -->
    ...
    <link rel="stylesheet" href="{{asset('public/plugins/bootstrap-sweetalert/sweetalert.css')}}">
    {{--<!-- Bootstrap -->--}}
    {{--<link rel="stylesheet" href="{{asset('public/plugins/bootstrap/css/bootstrap.min.css')}}">--}}

    <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,600" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('public/css/custom.css')}}">
    <link rel="stylesheet" href="{{asset('public/css/'.setting("theme_color","primary").'.css')}}">
    @yield('css_custom')
</head>

<body style="height: 100%; background-color: #f9f9f9;" class="hold-transition sidebar-mini {{setting('theme_color')}} @if(app()->getLocale() == 'he') rtl @endif">
@if(auth()->check())
    <div class="wrapper">
        <!-- Main Header -->
        <!-- Navbar -->
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <footer class="main-footer {{setting('fixed_footer','')}}">
            ...
            <div class="modal" id="newOrderAlert">
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success redirect_me_to_given_url" data-href="{{URL::to('orders')}}">Take me to order list</button>
              </div>
...
@else
    ...
    <!-- daterangepicker -->
    {{--<script src="{{asset('public/https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js')}}"></script>--}}
    ...
    <script src="{{asset('public/plugins/bootstrap-sweetalert/sweetalert.min.js')}}"></script>
    <!-- FastClick -->
