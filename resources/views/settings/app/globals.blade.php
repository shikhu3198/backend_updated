        ...
        <div class="card-body">
            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <div class="form-group row">
                        {!! Form::label('announcement', trans("lang.app_setting_announcement"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('announcement', setting('announcement'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_announcement_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_announcement_help") }}
                            </div>
                        </div>
                    </div>
                </div>
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <!-- App Version -->
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-8">
                            {!! Form::text('app_version', setting('app_version'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_app_version_placeholder")]) !!}
                            <div class="form-text text-muted">
                 ...
                 <div class="container form-group row">
                    {!! Form::label('block_checkout', trans("lang.app_setting_block_checkout"),['class' => 'col-4 switch control-label text-right']) !!}
                    <div class="col-8">
                    <label class="switch" for="checkbox">

                <input type="checkbox" {{ ( setting('block_checkout') == '1' ) ? 'checked' : '' }} id="checkbox" >
                    <div class="slider round"></div>
                  </label>
                <div class="form-text text-muted">
                       {{ trans("lang.app_setting_block_checkout_help") }}
                </div>
              </div>

                  <input type="hidden" value="{!! setting('block_checkout')  !!}" name="block_checkout" id="block_checkout">
                </div>
                <!-- /Block Checkout  -->


                     <!-- Block CheckOut Message -->
                     <div id="block_checkout_msg_div" {{ ( setting('block_checkout') == '1' ) ? '' : "style=display:none" }} class="form-group row">
                        {!! Form::label('block_checkout_msg', trans("lang.app_setting_block_checkout_msg"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('block_checkout_msg', setting('block_checkout_msg'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_block_checkout_msg_placeholder"),'id'=>'block_checkout_msg']) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_block_checkout_msg_help") }}
                            </div>
                        </div>
                    </div>
                    <!-- /Block CheckOut Message -->
                    ...
                    <div class="form-group row">
                        {!! Form::label('town_area_lat', trans("lang.app_setting_lat"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('town_area_lat', setting('town_area_lat'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_lat_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_lat_help") }}
                            </div>
                        </div>
                    </div>

                     <div class="form-group row">
                        {!! Form::label('town_area_long', trans("lang.app_setting_long"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('town_area_long', setting('town_area_long'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_long_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_long_help") }}
                            </div>
                        </div>
                    </div>

                    <div class="form-group row">
                        {!! Form::label('town_area_distance', trans("lang.app_setting_distance"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('town_area_distance', setting('town_area_distance'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_distance_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_distance_help") }}
                            </div>
                        </div>
                    </div>

                     <div class="form-group row">
                        {!! Form::label('town_area_message', trans("lang.app_setting_prevent_msg"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('town_area_message', setting('town_area_message'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_prevent_msg_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_prevent_msg_help") }}
                            </div>
                        </div>
                    </div>

                    <div class="form-group row">
                        {!! Form::label('message_close', trans("lang.app_setting_message_close"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('message_close', setting('message_close'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_message_close_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_message_close_help") }}
                            </div>
                        </div>
                    </div>
...
@push('scripts_lib')
    ...
    var ckbox = $('#checkbox');
        if(ckbox.is(':checked'))
        {
            $("#block_checkout").val("1");  
            $("#block_checkout_msg_div").show();
        }
        else{
                $("#block_checkout").val("0");
                $("#block_checkout_msg_div").hide();
        }  
    }); 
    </script>
