...
<script type="text/javascript">
    ...
    var dz_var15671147051368295516ble = $(".dropzone.image").dropzone({
        ...
        removedfile: function (file) {
            dzRemoveFile(
                file, var15671147051368295516ble, '{!! url("res_categories/remove-media") !!}',
...
<div class="form-group col-12 text-right">
  ...
  <a href="{!! route('res_categories.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
